...
新增包：`src/main/java/com/nano/snapshot/`
...
```text
~/.nano/snapshots/<project_hash>/<worktree_hash>/.git
```
...
```bash
-Dnano.snapshot.enabled=false
-Dnano.snapshot.max=50
-Dnano.snapshot.excludes=...
```
