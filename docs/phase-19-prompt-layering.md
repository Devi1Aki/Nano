...
2. 用户级覆盖：`~/.nano/prompts/...`
3. 项目级覆盖：`.nano/prompts/...`

例如：

```text
~/.nano/prompts/base.md
~/.nano/prompts/modes/agent.md
.nano/prompts/modes/team-worker.md
```
...
- [x] 支持用户级覆盖 `~/.nano/prompts/...`
- [x] 支持项目级覆盖 `.nano/prompts/...`
- [x] 校验 `## Language`
- [x] ReAct 接入
