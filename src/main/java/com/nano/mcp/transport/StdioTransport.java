package com.nano.mcp.transport;
    ...
    private void startStdoutReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[nano] stdout reader stopped: " + e.getMessage());
            }
        }, "nano-mcp-stdio-stdout");
    ...
    private void startStderrReader() {
        Thread thread = new Thread(() -> {
            try (BufferedReader reader = new BufferedReader(
                ...
                appendStderr("[nano] stderr reader stopped: " + e.getMessage());
            }
        }, "nano-mcp-stdio-stderr");
        thread.setDaemon(true);
        thread.start();
    }
