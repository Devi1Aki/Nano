...
public class RuntimeThreadStore implements AutoCloseable {
    ...
    public static Path defaultDbPath() {
        String configured = System.getProperty("nano.runtime.dir");
        if (configured == null || configured.isBlank()) {
            configured = System.getenv("NANO_RUNTIME_DIR");
        }
        if (configured == null || configured.isBlank()) {
            configured = Path.of(System.getProperty("user.home"), ".nano", "runtime").toString();
        }
