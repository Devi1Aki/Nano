...
import com.nano.tui.history.ConversationSnapshot;
import com.nano.tui.pane.CenterPane;
import com.nano.tui.pane.StatusPane;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    public TuiSessionController(NanoConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "nano-tui-agent-runner");
