...
import com.nano.memory.MemoryEntry;
...
class AgentMemoryHintTest {
    ...
    void explicitChromeRememberRequestStoresSitePreferenceInLongTermMemory() {
        String oldMemoryDir = System.getProperty("nano.memory.dir");
        System.setProperty("nano.memory.dir", tempDir.toString());
        try {
            ...
            if (oldMemoryDir == null) {
                System.clearProperty("nano.memory.dir");
            } else {
                System.setProperty("nano.memory.dir", oldMemoryDir);
            }
        }
    }
