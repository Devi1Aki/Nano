...
class LlmClientFactoryTest {
    ...
    void createsGlm5vTurboClientWithMultimodalEndpoint() {
        ...
        config.getProviders().put("glm",
                new NanoConfig.ProviderConfig("test-glm-key", null, "glm-5v-turbo"));
    ...
    void createsStepClientFromConfiguredProvider() {
        ...
        config.getProviders().put("step",
                new NanoConfig.ProviderConfig("test-step-key", null, "step-3.5-flash-2603"));
    ...
    void returnsNullForUnknownProvider() {
        NanoConfig config = new NanoConfig();
        config.getProviders().put("unknown", new NanoConfig.ProviderConfig("test-key", null, "unknown-model"));
